...
public:
    ...
    QAction *actionAgl_all;
    QAction *actionStatgen_all;
    ...
    QPushButton *trj_pushButton_output;
    ...
    QPushButton *statgen_pushButton_input;
    ...
    QHBoxLayout *statgen_layout_out_3;
    QCheckBox *statgen_checkBox_anal;
    QDoubleSpinBox *statgen_doubleSpinBox_anal;
    QSpacerItem *horizontalSpacer_16;
    QCheckBox *statgen_checkBox_graph;
    ...
    QPushButton *radf_pushButton_input;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionAgl_all = new QAction(MainWindow);
        actionAgl_all->setObjectName(QString::fromUtf8("actionAgl_all"));
        actionStatgen_all = new QAction(MainWindow);
        actionStatgen_all->setObjectName(QString::fromUtf8("actionStatgen_all"));
        ...
        trj_lineEdit_output->setMinimumSize(QSize(320, 23));

        trj_layout_output->addWidget(trj_lineEdit_output);

        trj_pushButton_output = new QPushButton(trj);
        trj_pushButton_output->setObjectName(QString::fromUtf8("trj_pushButton_output"));
        trj_pushButton_output->setMinimumSize(QSize(80, 23));
        trj_pushButton_output->setAutoDefault(true);

        trj_layout_output->addWidget(trj_pushButton_output);
        ...
        verticalLayout_6 = new QVBoxLayout(statgen);
        ...
        verticalLayout_6->addLayout(statgen_layout_workDir);
        ...
        statgen_pushButton_input = new QPushButton(statgen);
        statgen_pushButton_input->setObjectName(QString::fromUtf8("statgen_pushButton_input"));
        statgen_pushButton_input->setMinimumSize(QSize(80, 23));
        statgen_pushButton_input->setAutoDefault(true);

        statgen_layout_input->addWidget(statgen_pushButton_input);


        verticalLayout_6->addLayout(statgen_layout_input);
        ...
        verticalLayout_6->addLayout(statgen_layout_steps);
        ...
        verticalLayout_6->addLayout(statgen_layout_cell);
        ...
        verticalLayout_6->addLayout(statgen_layout_atoms);
        ...
        verticalLayout_6->addLayout(statgen_layout_int);
        ...
        verticalLayout_6->addWidget(statgen_listWidget_int);
        ...
        verticalLayout_6->addLayout(stagen_layout_intRem);
        ...
        verticalLayout_6->addLayout(statgen_layout_output);
        ...
        verticalLayout_6->addLayout(statgen_layout_opt);

        statgen_layout_out_3 = new QHBoxLayout();
        statgen_layout_out_3->setSpacing(6);
        statgen_layout_out_3->setObjectName(QString::fromUtf8("statgen_layout_out_3"));
        statgen_checkBox_anal = new QCheckBox(statgen);
        statgen_checkBox_anal->setObjectName(QString::fromUtf8("statgen_checkBox_anal"));
        statgen_checkBox_anal->setMinimumSize(QSize(110, 23));

        statgen_layout_out_3->addWidget(statgen_checkBox_anal);

        statgen_doubleSpinBox_anal = new QDoubleSpinBox(statgen);
        statgen_doubleSpinBox_anal->setObjectName(QString::fromUtf8("statgen_doubleSpinBox_anal"));
        statgen_doubleSpinBox_anal->setEnabled(false);
        statgen_doubleSpinBox_anal->setMinimumSize(QSize(80, 23));
        statgen_doubleSpinBox_anal->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        statgen_doubleSpinBox_anal->setMaximum(1);
        statgen_doubleSpinBox_anal->setSingleStep(0.1);
        statgen_doubleSpinBox_anal->setValue(0.05);

        statgen_layout_out_3->addWidget(statgen_doubleSpinBox_anal);

        horizontalSpacer_16 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        statgen_layout_out_3->addItem(horizontalSpacer_16);

        statgen_checkBox_graph = new QCheckBox(statgen);
        statgen_checkBox_graph->setObjectName(QString::fromUtf8("statgen_checkBox_graph"));
        statgen_checkBox_graph->setMinimumSize(QSize(110, 23));
        statgen_checkBox_graph->setChecked(true);

        statgen_layout_out_3->addWidget(statgen_checkBox_graph);

        horizontalSpacer_17 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        statgen_layout_out_3->addItem(horizontalSpacer_17);


        verticalLayout_6->addLayout(statgen_layout_out_3);
        ...
        radf_pushButton_input = new QPushButton(radf);
        radf_pushButton_input->setObjectName(QString::fromUtf8("radf_pushButton_input"));
        radf_pushButton_input->setMinimumSize(QSize(80, 23));
        radf_pushButton_input->setAutoDefault(true);

        radf_layout_input->addWidget(radf_pushButton_input);
        ...
        radf_checkBox_graph = new QCheckBox(radf);
        radf_checkBox_graph->setObjectName(QString::fromUtf8("radf_checkBox_graph"));
        radf_checkBox_graph->setMinimumSize(QSize(80, 23));
        radf_checkBox_graph->setChecked(true);

        radf_layout_buttons->addWidget(radf_checkBox_graph);
        ...
        QWidget::setTabOrder(trj_lineEdit_output, trj_pushButton_output);
        QWidget::setTabOrder(trj_pushButton_output, trj_spinBox_totalTypes);
        ...
        QWidget::setTabOrder(statgen_lineEdit_input, statgen_pushButton_input);
        QWidget::setTabOrder(statgen_pushButton_input, statgen_spinBox_stepsFirst);
        ...
        QWidget::setTabOrder(statgen_pushButton_log, statgen_checkBox_anal);
        QWidget::setTabOrder(statgen_checkBox_anal, statgen_doubleSpinBox_anal);
        QWidget::setTabOrder(statgen_doubleSpinBox_anal, statgen_checkBox_graph);
        QWidget::setTabOrder(statgen_checkBox_graph, statgen_pushButton_clear);
        ...
        QWidget::setTabOrder(radf_lineEdit_input, radf_pushButton_input);
        QWidget::setTabOrder(radf_pushButton_input, radf_spinBox_stepsFirst);
        ...
        QWidget::setTabOrder(radf_pushButton_clear, radf_checkBox_graph);
        QWidget::setTabOrder(radf_checkBox_graph, radf_pushButton_start);
        ...
        menuMenu->addAction(menu_Tools->menuAction());
        ...
        menu_Tools->addAction(actionAgl_all);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionAgl_all->setText(QApplication::translate("MainWindow", "agl_all", 0, QApplication::UnicodeUTF8));
        actionStatgen_all->setText(QApplication::translate("MainWindow", "statgen_all", 0, QApplication::UnicodeUTF8));
        ...
        trj_pushButton_output->setText(QApplication::translate("MainWindow", "Browse", 0, QApplication::UnicodeUTF8));
        ...
        statgen_pushButton_input->setText(QApplication::translate("MainWindow", "Browse", 0, QApplication::UnicodeUTF8));
        ...
        statgen_checkBox_anal->setText(QApplication::translate("MainWindow", "Analysis", 0, QApplication::UnicodeUTF8));
        statgen_checkBox_graph->setText(QApplication::translate("MainWindow", "Graph", 0, QApplication::UnicodeUTF8));
        ...
        radf_pushButton_input->setText(QApplication::translate("MainWindow", "Browse", 0, QApplication::UnicodeUTF8));
        ...
        radf_checkBox_graph->setText(QApplication::translate("MainWindow", "Graph", 0, QApplication::UnicodeUTF8));
